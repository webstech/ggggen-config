...
function genConfig(config, format) {
...
async function loadConfig(file) {
    ...
    if (path_1.default.extname(file) === ".js") {
        const { default: newConfig } = (await Promise.resolve().then(() => __importStar(require(file))));
...
const fs = __importStar(__nccwpck_require__(147));
const path_1 = __importDefault(__nccwpck_require__(17));
const project_config_1 = __nccwpck_require__(520);
const gen_config_1 = __nccwpck_require__(141);
async function run() {
    try {
        const inputs = {
        ...
        const file = path_1.default.resolve(inputs.config);
        const config = await (0, project_config_1.loadConfig)(file);
        const configOut = (0, gen_config_1.genConfig)(config, format);
        console.info(configOut);
        const fd = fs.openSync(path_1.default.resolve(inputs.file), "w");
